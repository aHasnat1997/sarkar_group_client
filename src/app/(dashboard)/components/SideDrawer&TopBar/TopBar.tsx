        ...
        <Stack justifyContent="space-between" alignItems="center" width="100%">
          <Box>
            <Typography variant="h5" fontWeight="600" color="text.primary">
              {currentStoredUser
                ? `Hello ${capitalizeLetter(
                    currentStoredUser?.data?.role.split("_").join(" ")
                  )}👋🏻`
                : ""}
            </Typography>
            ...
            <MenuButton
              buttonTitle={
                ...
                >
                  ...
                  >
                    {currentStoredUser &&
                    currentStoredUser?.data?.profileImage?.secure_url ? (
                      <Image
                        alt="profile-image"
                    ...
                    <Box textAlign="left">
                      ...
                      >
                        {currentStoredUser
                          ? capitalizeLetter(
                              currentStoredUser?.data?.profileData?.designation
                                .split("_")
                                .join(" ")
                            )
                          : ""}
