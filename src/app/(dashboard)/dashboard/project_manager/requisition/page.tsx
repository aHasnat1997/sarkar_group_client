...
import { useMyRequisitionsQuery } from "@/redux/api/endpoints/requisitionsApi";
...
export default function Requisition() {
  ...
  const { data: requisitionData, isLoading, isFetching, isError } = useMyRequisitionsQuery({ page, limit });
