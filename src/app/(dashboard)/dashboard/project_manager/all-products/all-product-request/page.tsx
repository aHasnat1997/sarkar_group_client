...
import { useMyRequestProductsQuery } from "@/redux/api/endpoints/requestProductsApi";
...
import ViewDialogs from "./viewDialog";

export default function AllProductRequest() {
  const [page, setPage] = useState(1);
  const [limit, setLimit] = useState(10);

  const { data: productsRequestData, isLoading, isFetching, isError } = useMyRequestProductsQuery({ page, limit });
