...
} from "@/redux/api/endpoints/employeesApi";
  ...
  return (
    <Form {...methods}>
      ...
      >
        ...
        <Box p={3}>
          {value === 0 ? (
            <TabOne methods={methods} image={image} setImage={setImage} />
          ) : value === 1 ? (
            <TabTwo methods={methods} />
          ) : value === 2 ? (
            <TabThree files={files} setFiles={setFiles} />
          ) : (
            <></>
          )}
        </Box>
        ...
        <Box>
          <FormButton
            ...
            isLoading={
              isLoadingAdmin || isLoadingProjectManager || isLoadingEngineer
            }
            isSuccess={
              isSuccessAdmin || isSuccessProjectManager || isSuccessEngineer
            }
