              ...
              <Stack gap="1.5rem">
                <FormItem style={{ width: "100%" }}>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormInput {...field} label="User Name" />
                    )}
                  />
                </FormItem>
                <FormItem style={{ width: "100%" }}>
              ...
              <Stack gap="1.5rem">
                <FormItem style={{ width: "100%" }}>
                  <FormField
                    ...
                    control={methods.control}
                    render={({ field }) => (
                      <FormDatePicker {...field} label="Joining Date" />
                    )}
                  />
                </FormItem>
                ...
                <FormItem style={{ width: "100%" }}>
                  <FormField
                    ...
                    control={methods.control}
                    render={({ field }) => (
                      <FormInput {...field} label="Office Location" />
                    )}
                  />
                </FormItem>
              </Stack>
