...
import {
  ...
  projectUpdateSchema,
} from "../../add-new-project/form/formZodSchema";
...
export default function DialogOne({
  ...
  const projectStatusType = ["Completed", "In_Process", "ON_GOING"];

  const [updateProjectData, { isLoading, isError, isSuccess }] =
              ...
              <Stack gap="1.5rem">
                <FormItem style={{ width: "100%" }}>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormInput {...field} label="Project Name" />
                    )}
                  />
                </FormItem>
                <FormItem style={{ width: "100%" }}>
              ...
              <Stack gap="1.5rem">
                <FormItem style={{ width: "100%" }}>
                  <FormField
                    ...
                    control={methods.control}
                    render={({ field }) => (
                      <FormDatePicker {...field} label="Starting Date" />
                    )}
                  />
                </FormItem>
                <FormItem style={{ width: "100%" }}>
