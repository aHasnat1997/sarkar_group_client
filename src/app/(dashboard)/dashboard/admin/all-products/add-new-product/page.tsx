                ...
                <Grid2 size={6} key={i} position="relative">
                  {
                    <>
                      <div
                        ...
                        onClick={() =>
                          image.public_id && handleImageRemove(image.public_id)
                        }
                      >
                        <CloseIcon />
                      </div>
          ...
          >
            <Box>
              ...
              <Typography color="textSecondary">
                Provide a general information about the equipment you would like
                to create.
              </Typography>
            </Box>
            ...
            <Stack gap="1rem">
              ...
              <FormItem style={{ width: "100%" }}>
                <FormField
                  ...
                  control={methods.control}
                  render={({ field }) => (
                    <FormInput {...field} label="Chartered Person Address" />
                  )}
                />
              </FormItem>
            </Stack>
            ...
            <Stack gap="1rem">
              ...
              <FormItem style={{ width: "100%" }}>
                <FormField
                  name="model"
                  control={methods.control}
                  render={({ field }) => <FormInput {...field} label="Model" />}
                />
              </FormItem>
            </Stack>
