...
import { useMyApplicationsQuery } from "@/redux/api/endpoints/applicationsApi";
...
export default function Application() {
  ...
  const { data: applicationData, isLoading, isFetching, isError } = useMyApplicationsQuery({ page, limit });
